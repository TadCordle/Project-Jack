...
namespace Badminton.Screens
{
	class SingleMap : GameScreen
	{
		...
		public SingleMap()
		{
			...
			testFigure1 = new LocalPlayer(world, new Vector2(480 * MainGame.PIXEL_TO_METER, 480 * MainGame.PIXEL_TO_METER), Category.Cat1, 1f, Color.Red, PlayerIndex.One);
			testFigure2 = new LocalPlayer(world, new Vector2(1200 * MainGame.PIXEL_TO_METER, 480 * MainGame.PIXEL_TO_METER), Category.Cat2, 1f, Color.Green, PlayerIndex.Two);
