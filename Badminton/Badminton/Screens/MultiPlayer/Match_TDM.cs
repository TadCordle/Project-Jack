...
namespace Badminton.Screens.MultiPlayer
{
	class Match_TDM : GameScreen
    {
        ...
        public Match_TDM()
        {
            ...
            testFigure2 = new LocalPlayer(world, new Vector2(1200 * MainGame.PIXEL_TO_METER, 480 * MainGame.PIXEL_TO_METER), Category.Cat1, 1.5f, Color.Pink, PlayerIndex.Two);
