...
namespace Badminton.Screens.MultiPlayer
{
	class FreeForAll : GameScreen
    {
        ...
        public FreeForAll()
        {
            ...
            testFigure3 = new LocalPlayer(world, new Vector2(900 * MainGame.PIXEL_TO_METER, 480 * MainGame.PIXEL_TO_METER), Category.Cat3, 1.5f, Color.Blue, PlayerIndex.Three);
            testFigure4 = new LocalPlayer(world, new Vector2(1000 * MainGame.PIXEL_TO_METER, 480 * MainGame.PIXEL_TO_METER), Category.Cat4, 1.5f, Color.Cyan, PlayerIndex.Four);
